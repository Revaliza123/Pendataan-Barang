      ...
      <div class="row g-0 h-100">
          ...
          <div class="container p-5 col-lg-10">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div style="overflow-x:auto;">
                  <div class="my-3 col-12 col-sm-8 col-md-6 ms-2">
                    <form action="" method="get">
                      <div class="input-group mb-3">
                        <input class="form-control" type="search" name="Search" placeholder="Search by nama dan satuan" aria-label="Search" id="Search">
                ...
                <!-- <a href="#" class="btn btn-outline-success mb-3 float-end">Data Yang Sudah Di Hapus</a> -->
                <table class="table table-straped" id="table">
                  <tr>
                              <td>No</td>
                              <th>Nama Barang</th>
                              <th>Tanggal</th>
...
$('#Search').on('keyup',function(){
  ...
  $.ajax({
    type: 'get',
    url:'{{ URL::to('/admin/keluar/data-keluar') }}',
    data:{'Search':$value},
